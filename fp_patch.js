...
function injectBtns(){
  ...
  var syncBtn=null;
  topbar.querySelectorAll(".btn-secondary").forEach(function(b){
    if(b.textContent.indexOf("ynchroniser")>-1)syncBtn=b;
  });
  if(!syncBtn)syncBtn=topbar.querySelector(".btn-secondary");
  if(!syncBtn)return;
