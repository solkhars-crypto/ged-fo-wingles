...
var IT_CATS={
  cse:{l:'CSE',c:'#3B82F6'},cssct:{l:'CSSCT',c:'#22C55E'},
  heures:{l:'Heures délégation',c:'#EAB308'},pse:{l:'PSE',c:'#EA580C'},
  harcelement:{l:'Harcèlement',c:'#E03A47'},discrimination:{l:'Discrimination',c:'#A855F7'},
  salaire:{l:'Salaire / Prime',c:'#06B6D4'},securite:{l:'Sécurité / AT',c:'#F97316'},
  nao:{l:'NAO / Accord',c:'#0D9488'},autre:{l:'Autre',c:'#6B7280'}
};
var IT_ST={
  envoye:{l:'Envoyé',cls:'env',i:'📤'},repondu:{l:'Répondu',cls:'rep',i:'✅'},
  relance:{l:'Relancé',cls:'rel',i:'⚠️'},classe:{l:'Classé',cls:'cls',i:'📁'}
};
var itData=[],itCurFilter='all';
...
function itRender(){
  ...
  if(!el)return;
  if(!list.length){el.innerHTML='<div class="it-empty">Aucun courrier — cliquez ＋ Nouveau</div>';return;}
