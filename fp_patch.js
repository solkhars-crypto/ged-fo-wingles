...
function itView(id){
  ...
  if(!c.fileData){
    ...
    if(mime==="application/pdf"||ext==="pdf"){
      ...
      ifr.src=c.fileData;
      ifr.style.cssText="width:100%;flex:1;min-height:700px;border:none;background:#fff";
